...
{
    /// <inheritdoc />
    public partial class anothernewinit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FK_RequestVacation = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CurrentVacId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AcceptReject = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaitingRequests", x => x.CurrentVacId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FK_WaitingRequestModel = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestVacations_WaitingRequests_FK_WaitingRequestModel",
                        column: x => x.FK_WaitingRequestModel,
                        principalTable: "WaitingRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestVacations_FK_WaitingRequestModel",
                table: "RequestVacations",
                column: "FK_WaitingRequestModel");
